...
@section('content')
<!-- Welcome Banner Card -->
<div class="relative flex flex-col min-w-0 break-words bg-[#0f172a] rounded-2xl mb-6 text-white overflow-hidden p-6">
    <div class="relative z-10 flex flex-wrap items-center justify-between gap-4">
        <div class="flex items-center gap-4">
            <div class="w-14 h-14 rounded-2xl bg-white/10 border border-white/20 flex items-center justify-center text-2xl text-blue-300">
...
<div class="flex flex-wrap -mx-3 removable">
    ...
    <div class="w-full max-w-full px-3 mb-4 sm:w-1/2 xl:w-1/4 flex">
        <div class="relative flex flex-col justify-between min-w-0 w-full break-words bg-white rounded-2xl p-5 border border-slate-200">
            <div class="flex items-center justify-between">
                ...
                <div class="w-12 h-12 rounded-xl bg-blue-600 flex items-center justify-center text-white text-lg flex-shrink-0">
    ...
    <div class="w-full max-w-full px-3 mb-4 sm:w-1/2 xl:w-1/4 flex">
        <div class="relative flex flex-col justify-between min-w-0 w-full break-words bg-white rounded-2xl p-5 border border-slate-200">
            <div class="flex items-center justify-between">
                ...
                <div class="w-12 h-12 rounded-xl bg-emerald-600 flex items-center justify-center text-white text-lg flex-shrink-0">
    ...
    <div class="w-full max-w-full px-3 mb-4 sm:w-1/2 xl:w-1/4 flex">
        <div class="relative flex flex-col justify-between min-w-0 w-full break-words bg-white rounded-2xl p-5 border border-slate-200">
            <div class="flex items-center justify-between">
                ...
                <div class="w-12 h-12 rounded-xl bg-orange-500 flex items-center justify-center text-white text-lg flex-shrink-0">
    ...
    <div class="w-full max-w-full px-3 mb-4 sm:w-1/2 xl:w-1/4 flex">
        <div class="relative flex flex-col justify-between min-w-0 w-full break-words bg-white rounded-2xl p-5 border border-slate-200">
            <div class="flex items-center justify-between">
                ...
                <div class="w-12 h-12 rounded-xl bg-rose-600 flex items-center justify-center text-white text-lg flex-shrink-0">
