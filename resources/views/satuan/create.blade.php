...
@section('title', 'Tambah Satuan - Inventory Gudang')
    ...
    <div class="w-full max-w-full px-3">
        ...
        <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
            ...
            <div class="p-6 pb-0 mb-0 border-b-0 border-solid border-black-125 rounded-t-2xl flex justify-between items-center">
                <h6 class="font-bold text-slate-800 text-lg">Form Tambah Satuan Baru</h6>
            ...
            <div class="flex-auto p-6">
                <form action="{{ route('satuan.store') }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="nama_satuan" id="nama_satuan" value="{{ old('nama_satuan') }}" required placeholder="Contoh: LBR, ROLL, PCS, BOX" class="w-full px-3 py-2 text-sm text-slate-700 placeholder-slate-400 bg-white border border-gray-300 rounded-lg focus:border-blue-500 focus:outline-none transition-colors">
                        <p class="text-xs text-slate-400 mt-1">Masukkan nama singkatan satuan (gunakan huruf kapital).</p>
                    </div>
                    ...
                    <div class="flex justify-start gap-3 border-t pt-4">
                        <button type="submit" class="px-6 py-3 font-bold text-white uppercase bg-blue-600 hover:bg-blue-700 rounded-lg transition-colors text-xs tracking-wider">
                            <i class="fa fa-save mr-1"></i> Simpan Satuan
                        </button>
