                ...
                <form action="{{ route('user.update', $user->id) }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        ...
                        <div>
                            ...
                            <select name="role" id="role" required class="w-full px-3 py-2 text-sm text-slate-700 bg-white border border-gray-300 rounded-lg focus:border-blue-500 focus:outline-none transition-colors cursor-pointer" {{ $user->isSuperAdmin() ? 'disabled' : '' }}>
                                <option value="" disabled {{ old('role', $user->role) ? '' : 'selected' }}>-- Pilih Jabatan --</option>
